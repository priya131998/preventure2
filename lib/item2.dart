...
class Item2 extends StatelessWidget {
  static String myVideoId2 = 'SHPcVO0xDrA';

  // Initiate the Youtube player controller
  YoutubePlayerController _controller = YoutubePlayerController(
    initialVideoId: myVideoId2,
          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                ...
                child: Text(
                  'We have made it even easier to identify and reduce the risk of ankle, knee and lower back injuries due to',
                  style: TextStyle(
